...
# Bot information
API_ID = environ.get('API_ID', '10261086')
if len(API_ID) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '1426588906')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001878854070').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1001606248152').split()]
if len(AUTH_CHANNEL) == 0:
    print('Info - AUTH_CHANNEL is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1001606248152')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1001891653000')
...
# for stream
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002023567286")
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://jkop-a6087d50d20d")
if len(URL) == 0:
